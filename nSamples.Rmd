...
To test the effect of the number of samples we picked subsets of various sizes out of the 1363 _At_ samples available and calculated ORS (PCC+MI) against the full set of _Os_ samples (454 samples). Only 1:1 orthologs were included (~5k genes) to save computation time.
